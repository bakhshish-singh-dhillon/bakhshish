...
import socialMediaPic from '../img/Bakhshish-Singh-Dhillon-t.png'
...
const Head = ({ title }) => {
    return (
            <Helmet>
                ...
                <meta property="og:image" content={`https://www.bakhshishsingh.com${socialMediaPic}`}/>
                ...
                <meta name="twitter:image" content={`https://www.bakhshishsingh.com${socialMediaPic}`}/>
